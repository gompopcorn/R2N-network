...
createcertificatesForOrg3() {
  ...
  fabric-ca-client register --caname ca.org3.example.com --id.name orderer0 --id.secret orderer0pw --id.type orderer --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem

  echo
  echo "Register orderer1"
  echo

  fabric-ca-client register --caname ca.org3.example.com --id.name orderer1 --id.secret orderer1pw --id.type orderer --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  ...
  # --------------------------------------------------------------------------------------------------
  # Orderer 0
  mkdir -p ../crypto-config/peerOrganizations/org3.example.com/orderers/orderer0.org3.example.com
  
  echo
  echo "## Generate the orderer0 msp"
  echo

  fabric-ca-client enroll -u https://orderer0:orderer0pw@localhost:9054 --caname ca.org3.example.com -M ${PWD}/../crypto-config/peerOrganizations/org3.example.com/orderers/orderer0.org3.example.com/msp --csr.hosts orderer0.org3.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem

  cp ${PWD}/../crypto-config/peerOrganizations/org3.example.com/msp/config.yaml ${PWD}/../crypto-config/peerOrganizations/org3.example.com/orderers/orderer0.org3.example.com/msp/config.yaml

  echo
  echo "## Generate the orderer0-tls certificates"
  echo

  fabric-ca-client enroll -u https://orderer0:orderer0pw@localhost:9054 --caname ca.org3.example.com -M ${PWD}/../crypto-config/peerOrganizations/org3.example.com/orderers/orderer0.org3.example.com/tls --enrollment.profile tls --csr.hosts orderer0.org3.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem

  cp ${PWD}/../crypto-config/peerOrganizations/org3.example.com/orderers/orderer0.org3.example.com/tls/tlscacerts/* ${PWD}/../crypto-config/peerOrganizations/org3.example.com/orderers/orderer0.org3.example.com/tls/ca.crt
  cp ${PWD}/../crypto-config/peerOrganizations/org3.example.com/orderers/orderer0.org3.example.com/tls/signcerts/* ${PWD}/../crypto-config/peerOrganizations/org3.example.com/orderers/orderer0.org3.example.com/tls/server.crt
  cp ${PWD}/../crypto-config/peerOrganizations/org3.example.com/orderers/orderer0.org3.example.com/tls/keystore/* ${PWD}/../crypto-config/peerOrganizations/org3.example.com/orderers/orderer0.org3.example.com/tls/server.key
