...
fetchChannelBlock() {
    ...
    peer channel fetch 0 ./channel-artifacts/$CHANNEL_NAME.block -o 185.235.40.52:11050 \
        --ordererTLSHostnameOverride orderer0.org3.example.com \
...
updateAnchorPeers() {
    ...
    # Replace localhost with your orderer's vm IP address
    peer channel update -o 185.235.40.52:11050 --ordererTLSHostnameOverride orderer0.org3.example.com \
