...
approveForMyOrg1() {
    ...
    peer lifecycle chaincode approveformyorg -o 185.235.43.55:7050 \
...
commitChaincodeDefination() {
    setGlobalsForPeer0Org1
    peer lifecycle chaincode commit -o 185.235.43.55:7050 --ordererTLSHostnameOverride orderer0.org1.example.com \
...
chaincodeInvokeInit() {
    setGlobalsForPeer0Org1
    peer chaincode invoke -o 185.235.43.55:7050 \
